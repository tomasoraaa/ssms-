...
public class SystemConfigController {
    ...
    @GetMapping("/isMakeupExamScoreEntryEnabled")
    public Map<String, Object> isMakeupExamScoreEntryEnabled() {
        Map<String, Object> result = new HashMap<>();
        boolean enabled = systemConfigService.isMakeupExamScoreEntryEnabled();
        result.put("code", "200");
        result.put("data", enabled);
        result.put("enabled", enabled);
        return result;
    ...
    @PostMapping("/setMakeupExamScoreEntryEnabled/{enabled}")
