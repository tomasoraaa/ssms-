      ...
      <div class="card-body">
        <el-form :model="data.form" label-width="120px" class="password-form">
          ...
          <el-form-item label="原密码" required>
            <el-input v-model="data.form.password" show-password placeholder="请输入原密码" class="form-input" />
          </el-form-item>
          <el-form-item label="新密码" required>
            <el-input v-model="data.form.newPassword" show-password placeholder="请输入新密码" class="form-input" />
            <div class="password-hint">密码长度至少8位，包含字母和数字</div>
          </el-form-item>
          <el-form-item label="确认新密码" required>
            <el-input v-model="data.form.confirmPassword" show-password placeholder="请再次输入新密码" class="form-input" />
          </el-form-item>
          <div class="form-actions">
            <el-button type="primary" @click="save" class="save-button">修改密码</el-button>
          </div>
        </el-form>
      </div>
    </div>
...
onMounted(() => {
  ...
  data.form.role = user.role || 'TEACHER'
})
